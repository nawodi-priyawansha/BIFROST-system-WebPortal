...
<body class="font-sans">
    ...
    <div class="container mx-auto mt-24 px-4 overflow-y-auto" id="container">
        <div class=" bg-slate-50 ">
            <div class="breadcrumb text-sm mb-4 flex items-center">
                ...
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="w-full md:w-1/2 pr-4 space-y-6">
                        ...
                        <div class="form-group flex flex-wrap md:flex-nowrap items-center ">
                          ...
                          <div class="form-group flex flex-wrap md:flex-nowrap items-center ">
                            <label for="phone" class="block text-gray-700 font-bold w-full md:w-1/4 mb-1 md:mb-0 pr-4">Phone <span class="text-red-500">*</span></label>
                                <input type="tel" id="phone" name="phone" required class="md:w-2/4 form-control border rounded ml-1 px-4 py-2">
                        ...
                        <div class="form-group flex flex-wrap md:flex-nowrap items-center ">
                            ...
                            <label for="weight" class="block text-gray-700 font-bold w-full md:w-1/4 mb-1 md:mb-0 pr-4 ml-4">Weight <span class="text-red-500">*</span></label>
                        </div>
                         <!-- Primary Goal -->
                    ...
                    <!-- Right Column -->
                    <div class="w-full md:w-1/2 pl-4 space-y-6">
                        <!-- Nickname -->
                        <div class="form-group flex flex-wrap md:flex-nowrap items-center ">
