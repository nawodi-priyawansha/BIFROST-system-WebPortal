        ...
        <div class="mt-24 mx-4">
            ...
            <div class="flex flex-col gap-0">
                <div class="flex flex-col md:flex-row justify-center w-full">
                    <span class="text-4xl text-center md:w-[40%]"></span>
                    <span class="text-xl text-center md:w-[25%]"></span>
                    <span class=" hidden md:flex text-center md:w-[20%]">Add Goal</span>
                    <span class="  hidden md:flex text-center md:w-[15%]">View Goal</span>
                </div>
                <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 w-full mt-8">
                    <span class="text-4xl text-center md:w-[60%]">SMART Goal</span>
                    <span class="text-xl hidden md:flex text-center md:w-[20%]">+Goal Name</span>
                    <span class="text-xl hidden md:flex text-center md:w-[10%]">Test Goal</span>
                    <span class="text-xl hidden md:flex text-center md:w-[10%]">progress</span>
                </div>

                <!-- Specific -->
                <div class="flex flex-col md:flex-row w-full items-center mt-8">
                    <div class="flex items-center w-full md:w-[60%] flex-1">
                        <div class="w-16 h-20 flex items-center justify-center md:rounded-tl-full bg-[#CFE8E1]">
                    ...
                    <div class="w-16 h-20  items-center justify-center hidden md:flex rounded-tr-full bg-[#94DBC3]"></div>
                    <div class="md:ml-5 flex items-center w-full md:w-[20%]">
                        <input type="text" placeholder="" class="border border-black flex-1 h-14 my-2">
                    </div>
                    <div class="md:ml-5 flex text-center w-full md:w-[20%] h-20 mt-2">
                ...
                <div class="flex flex-col md:flex-row w-full items-center">
                    <div class="flex items-center w-full md:w-[60%] flex-1">
                        ...
                        <div class="w-20 h-20 hidden md:flex text-white text-6xl px-2 flex items-center justify-center font-bold bg-[#F6C653]">M</div>
                ...
                <div class="flex flex-col md:flex-row w-full items-center">
                    <div class="flex items-center w-full md:w-[60%] flex-1">
                        ...
                        <div class="w-20 h-20 hidden md:flex text-white text-6xl px-2 flex items-center justify-center font-bold bg-[#36B4E6]">A</div>
                ...
                <div class="flex flex-col md:flex-row w-full items-center">
                    <div class="flex items-center w-full md:w-[60%] flex-1">
                        ...
                        <div class="w-20 h-20 hidden md:flex text-white text-6xl px-2 flex items-center justify-center font-bold bg-[#EE492D]">R</div>
                    ...
                    <div class="w-16 h-20 hidden md:flex items-center justify-center bg-[#FABCA7]"></div>
                    <div class="md:ml-5 flex items-center w-full md:w-[20%]">
                        <input type="text" placeholder="" class="border border-black flex-1 h-14 my-2">
                    </div>
                    <div class="md:ml-5 flex text-center w-full md:w-[20%] h-20 mt-2">
                ...
                <div class="flex flex-col md:flex-row w-full items-center">
                    <div class="flex items-center w-full md:w-[60%] flex-1">
                        <div class="w-16 h-20 flex items-center justify-center bg-[#D9DADD] md:rounded-bl-full">
                            <img src="{{ asset('img/clock.png') }}" alt="Goal Icon" class="w-6 h-6">
                        </div>
                        <div class="w-20 h-20 hidden md:flex text-white text-6xl px-2 flex items-center justify-center font-bold bg-[#481F6E]">T</div>
                    ...
                    <div class="w-16 h-20 hidden md:flex items-center justify-center bg-[#D0C5DB] md:rounded-br-full"></div>
                    <div class="md:ml-5 flex items-center w-full md:w-[20%]">
                        <input type="time" placeholder="" class="border border-black flex-1 h-14 my-2 md:cursor-pointer">
                    </div>
                    <div class="md:ml-5 flex text-center w-full md:w-[20%] h-20 mt-2">
                        <div class="border border-black flex items-center h-14 my-2 w-2/3">
