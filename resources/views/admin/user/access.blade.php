                    ...
                    <tr class="border-b flex flex-col sm:table-row">
                        ...
                        <td class="py-2 pl-2 sm:pl-0 sm:w-full">
                            <div class="access-buttons text-xs flex flex-wrap gap-1 sm:gap-2 ">
                                <label for="users"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Users</label>
                                <label for="clients"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Clients</label>
                                <label for="jobs"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Jobs</label>
                                <label for="drivers"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Drivers</label>
                                <label for="timesheet"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Timesheet</label>
                                <label for="imessage"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">iMessage</label>
                                <label for="fuelLevy"
                                    class="border px-2 py-1 sm:px-4 sm:py-2  rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Fuel
                                    Levy</label>
                                <label for="truck"
                                    class="border px-4 py-2 rounded-md text-gray-500 hover:text-gray-700 cursor-pointer">Truck</label>
                            </div>
                            <div class="access-buttons flex flex-wrap gap-2 mt-2">
                                <label
                                    class="ml-2 text-sm border rounded-3xl px-2 py-1 bg-yellow-300"><strong>Account</strong></label>
                            </div>
                            <div class="access-buttons text-xs flex flex-wrap gap-1 sm:gap-2 mt-2 ">
                                <label class="border text-gray-500 border-gray-800 bg-white px-4 py-2 rounded-md md:w-auto"
                                    readonly>Accounts</label>
                                <label class="border text-gray-500 border-gray-300 bg-white px-4 py-2 rounded-md md:w-auto"
                                    readonly>Bank Ledger</label>
                                <label class="border text-gray-500 border-gray-300 bg-white px-4 py-2 rounded-md md:w-auto"
                                    readonly>Invoices</label>
                                <label
                                    class="border text-gray-500 border-gray-800 bg-white px-2 py-1 sm:px-4 sm:py-2 rounded-md md:w-auto"
                                    readonly>Outgoings</label>
                                <label class="border text-gray-500 border-gray-300 bg-white px-4 py-2 rounded-md md:w-auto"
                                    readonly>Journal</label>
                                <label
                                    class="border text-gray-500 border-gray-300 bg-white px-2 py-1 sm:px-4 sm:py-2 rounded-md md:w-auto"
                                    readonly>Summary</label>
                                <label class="border text-gray-500 border-gray-300 bg-white px-4 py-2 rounded-md md:w-auto"
                                    readonly>End Of Year</label>
                            </div>
                        </td>
                    </tr>
                    <tr class="border-b flex flex-col sm:table-row">
