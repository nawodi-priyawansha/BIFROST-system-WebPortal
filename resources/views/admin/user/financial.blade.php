                        ...
                        <div class="w-1/2 grid md:flex flex-col gap-4 flex-1 h-[675px] ">
                            ...
                            <div class="bg-white p-4 rounded shadow flex-1 flex-grow">
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        <div class="mb-2 flex justify-between items-center">
                                            <h3 class="text-xs font-semibold text-gray-800 dark:text-white">Owed 90+ days
                                            </h3>
                                            <span class="text-xs text-gray-800 dark:text-white">$2,4523.25</span>
                                        </div>
                                        <div class="flex w-full h-2 bg-gray-200 rounded-full overflow-hidden dark:bg-neutral-700"
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-5 w-full">
                            ...
                            <div>
                                <table class="min-w-full border-collapse border border-gray-200">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">20/05/2019
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">TC Printing
                                            </td>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">$150.00</td>
                                        </tr>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">04/03/2019
                                            </td>
