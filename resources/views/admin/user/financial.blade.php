    ...
    @section('content')
        ...
        <div class="container transition-width mt-24 flex-grow" id="container">
            <div class="breadcrumb text-sm mb-4">
                <a href="#" class="text-gray-500 no-underline hover:underline">Home</a> / <span><strong> Financial
                    </strong></span>
                {{-- tabmenu --}}
                ...
                <div class=" w-full container whitespace-nowrap  ">
                    <div class=" w-auto flex-nowrap whitespace-nowrap mt-10 " id="conatiner">
                        ...
                        <div
                            ...
                            <div
                                class="w-auto flex-1 text-center p-2 border flex-nowrap border-black relative bg-darkyellow ">
                            ...
                            <div
                                class="w-auto flex-1 text-center p-2 border flex-nowrap border-black bg-darkyellow relative">
                        ...
                        <div class="w-4/12  md:flex">
                            <div class="bg-white rounded-lg shadow-lg p-5 w-full">
                                ...
                                <div class="flex justify-center space-x-4 mt-7">
                                    <div
                                        class="bg-gray-200 p-4 w-48 h-36 flex flex-col justify-center items-center shadow-md">
