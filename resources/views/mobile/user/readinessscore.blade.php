                ...
                <div class="bg-transparent p-6 rounded-lg shadow-md pt-24">
                    ...
                    <div class="mb-4 flex flex-col text-center">
                        ...
                        <div class="flex items-center h-8 rounded overflow">
                            ...
                            <div class="flex-none">
                                <button class="hover:bg-transparent text-transparent text-center px-2 pointer-events-none" onclick=""><i
                    ...
                    <div class="mb-4 flex flex-col items-center justify-center text-center font-bold mb-4 text-white">
                        <div class="border border-white flex-col flex w-48 h-28 items-center justify-center rounded-lg">
                            ...
                            <div class="flex text-3xl text-center">
                                <input type="text" id="score" name="score" class="text-3xl text-center bg-transparent w-16"
                                    value="0"> %
                            </div>
                        </div>
                    </div>
